...
#Function to call out the pandandtilt object and use the yawtest method from the class
def YawTest():
    pt_object = PanAndTilt()
    raw_input("Starting Yaw Test... Press Key")
    pt_object.yaw_range_test()
#Function call out the pandantilt object and use the inputyawtest method from the class
def InputYawTest():
    pt_object = PanAndTilt()
    raw_input("Starting Yaw Test... Press Key")
    pt_object.input()

#This function calls out the yaw test or the inputyaw test... comment out which one 
